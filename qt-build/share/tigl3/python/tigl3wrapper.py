...
# This file is automatically created from tigl.h on 2018-02-21.
...
class Tigl3(object):
    ...
    def wingGetHello(self, wingIndex):
        # input arg conversion
        _c_wingIndex = ctypes.c_int(wingIndex)
        ...
        # call to native function
        errorCode = self.lib.tiglWingGetHello(self._handle, _c_wingIndex, ctypes.byref(_c_segmentCountPtr))
        catch_error(errorCode, 'tiglWingGetHello', wingIndex)
